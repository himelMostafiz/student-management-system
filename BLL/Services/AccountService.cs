...
namespace BLL.Services
{
    public class AccountService : IAccountService
    {
        ...
        public AccountService(UserManager<AppUser> userManager, IConfiguration configuration, IUnitOfWorkRepository unitOfWork, TaposRSA taposRsa, IDistributedCache cache)
        {
        ...
        private async Task StoreTokenInformation(long userId, string accessToken, string refreshToken)
        {
            ...
            //    .SetSlidingExpiration(TimeSpan.FromMinutes(IConfiguration.GetValue<int>("Jwt:AccessTokenLifeTime")));
